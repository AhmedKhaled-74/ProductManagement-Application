        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoeRegion = table.Column<decimal>(type: "decimal(5,3)", nullable: false),
                    ConstTax = table.Column<decimal>(type: "decimal(5,3)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductMass = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ProductVolume = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ProductPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VendorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BrandId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ProductCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductSubCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    NumberOfRemainingProducts = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    SoldTimes = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Discount = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 0m),
                    TotalRatedUsers = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    TotalStars = table.Column<int>(type: "int", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCustomAttributes", x => x.ProductCustomAttributeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductMediaURL = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedBackCreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhishListProducts", x => new { x.WhishListId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_WhishListProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WhishListProducts_WhishLists_WhishListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhishListProducts_ProductId",
                table: "WhishListProducts",
                column: "ProductId");
