...
{
    public class GetFilteredProductsHandler : IRequestHandler<GetFilteredProductsQuery, ErrorOr<ProductsListResult<ProductResult>>>
    {
        ...
        public GetFilteredProductsHandler(IProductUserGetterRepo productGetterRepo, IOptions<PaginationSetup> paginationOptions, IOptions<PriceConstsSetup> priceOptions)
        {
        ...
        public async Task<ErrorOr<ProductsListResult<ProductResult>>> Handle(GetFilteredProductsQuery request, CancellationToken cancellationToken)
        {
